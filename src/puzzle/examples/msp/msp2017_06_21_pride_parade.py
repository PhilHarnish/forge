...
(Harvey.right == True) - all(Harvey[i] - Kimball[i + 1] <= 0 for i in range(1, 7)) <= 0
...
(Harvey.red == True or Harvey.orange == True) - ((Kimball.red == True) or (Kimball.blue == True)) <= 0
...
chris_secondary - (chris_sees > courtney_sees) <= 0
